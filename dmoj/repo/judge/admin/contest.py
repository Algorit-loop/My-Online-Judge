...
class ContestAdmin(NoBatchDeleteMixin, SortableAdminBase, DiffVersionAdmin):
    fieldsets = (
        ...
        (_('Settings'), {'fields': ('is_visible', 'use_clarifications', 'push_announcements', 'disallow_virtual',
                                    ...
                                    'enable_focus_lock', 'points_precision', 'banned_judges')}),
        (_('Scheduling'), {'fields': ('start_time', 'end_time', 'registration_start', 'registration_end',
                                      'time_limit')}),
        (_('Details'), {'fields': ('description', 'og_image', 'logo_override_image', 'tags', 'summary')}),
        (_('Format'), {'fields': ('format_name', 'frozen_last_minutes', 'penalty_time_format', 'format_config', 'problem_label_style', 'problem_label_script')}),
