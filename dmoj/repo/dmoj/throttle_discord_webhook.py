...
def new_webhook():
    cache.add('error_discord_webhook_throttle', 0, settings.BKDNOJ_DISCORD_WEBHOOK_THROTTLING[1])
...
class ThrottledDiscordWebhookHandler(logging.Handler):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Send at most (BKDNOJ_DISCORD_WEBHOOK_THROTTLING[0]) message in
        # (BKDNOJ_DISCORD_WEBHOOK_THROTTLING[1]) seconds
        self.throttle = settings.BKDNOJ_DISCORD_WEBHOOK_THROTTLING[0]
