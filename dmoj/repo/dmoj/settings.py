...
ACE_URL = '/static/aloj/ace/1.4.14'
CODEMIRROR6_URL = '/static/aloj/codemirror6'
SELECT2_JS_URL = '/static/aloj/select2/4.0.3/js/select2.min.js'
SELECT2_CSS_URL = '/static/aloj/select2/4.0.3/css/select2.min.css'
...
AI_PROBLEM_CREATOR_ALLOWED_EXTS = {'png', 'jpg', 'jpeg', 'webp'}
...
GENSOL_MAX_ZIP_SIZE = 128 * 1024 * 1024
...
MOSS_API_KEY = 691430341

MOSS_API_KEY = 673727558
